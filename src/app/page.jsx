    ...
    return (
        <div className="overflow-hidden py-20 px-4 space-y-12">
            ...
            <div className="flex justify-center">
                <Link href="/search" className="inline-flex items-center justify-center bg-white rounded-md space-x-2 shadow-xl font-medium px-4 py-2">
                ...
                >
                    {
                        data.map((poster, index) => (
                            <SwiperSlide key={index}>
                                <img src={poster.file} style={{ width: "100%", height: "auto" }} />
                            </SwiperSlide>
                        ))
                    }
